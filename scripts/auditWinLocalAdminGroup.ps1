...
## Windows Admin Group Membership report
echo "Generating a Windows Admin Group Membership report (Plugin 10902). Provide a listing of what accounts are in the Admin Group on Windows systems."
$export = listSystems csv vulnerabilities vuln_by_asset 10902
Download-Report $export windows_admin_group_membership csv
